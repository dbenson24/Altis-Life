...
#define CASH life_displayedCash
#define BANK life_displayedBank
#define GANG_FUNDS grpPlayer getVariable ["gang_bank",0];
#define EXTDB_TAG "extDB2"
...
#define EXTDB_FAILED(MESSAGE) \
	APP_server_extDB_notLoaded = [true,##MESSAGE]; \
...
//System Macros
#define grpPlayer group _unit
#define steamid getPlayerUID _unit
