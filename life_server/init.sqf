...
/*
	...
	Description:
	Initialize the server and headless client and required systems.
*/
...
if(isNil {GVAR_UINS "SYS_sql_id"}) then {
	...
	if ((parseNumber _result) < 64) exitWith {EXTDB_FAILED("extDB2 version is not compatible with current Altis life version. Require version 64 or higher.")};
