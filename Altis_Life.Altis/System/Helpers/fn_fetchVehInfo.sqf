...
_weight = M_CONFIG(getNumber,CONFIG_VEHICLES,_class,"vItemSpace");

//Return
[_class,_scope,_picture,_displayName,_vehicleClass,_side,_faction,_superClass,_speed,_armor,_seats,_hp,_fuel,_weight];