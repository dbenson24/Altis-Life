...
_canUseControls = {
	...
	if((player GVAR ["restrained",FALSE]) OR (player GVAR ["Escorting",FALSE]) OR (player GVAR ["transporting",FALSE]) OR (APP_is_arrested) OR (APP_istazed)) then {false} else {true};
};
