...
if(!(createDialog "life_spawn_selection")) exitWith {[] call APP_fnc_spawnMenu;};
...
[((findDisplay 38500) displayCtrl 38502),1,0.1,getMarkerPos (_sp select 0)] call APP_fnc_setMapPosition;
APP_spawn_point = _sp;
